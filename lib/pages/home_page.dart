                ...
                Container(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      CityCard(City(
                          id: 1, name: "Surabaya", imageUrl: 'assets/city3.png')),
                      SizedBox(
                        width: 20,
                      ),
                      CityCard(City(
                          id: 1, name: "Palembang", imageUrl: 'assets/city4.png')),
                      SizedBox(
                        width: 20,
                      ),
                      CityCard(City(
                      ...
                      CityCard(
                          City(id: 1, name: "Bogor", imageUrl: 'assets/city6.png')),
                      SizedBox(
                        width: 24,
                      ),
                    ],
